...
/*
:Aliase type 
- Можно создать готовые шаблоны типов
- Рекомендация не использовать Aliase для объекта, для объектов лучше использовать inferface
- Рекомендация использовать заглавную букву для Aliase 
*/
